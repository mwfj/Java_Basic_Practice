...
public class MainModule {
	 ...
	 static void doSave() {
		...
		try {
			...
			d1.setName("Development Department");
			...
			d2.setName("Marketing Department");
			...
			d3.setName("Human Resource Department");
	 ...
	 static void doView() {
		...
		/*	List<Department> departments = 
			...
			List<Employee> employees = session
					...
					.list();
			for(Employee employee : employees) {
				System.out.println("Empolyee_name" + employee.getName() + " | Department_name" + employee.getDepartment().getName());
				System.out.println("-------------------------------------");
			}
