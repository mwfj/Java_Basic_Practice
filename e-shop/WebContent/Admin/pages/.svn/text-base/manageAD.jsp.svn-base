  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
    	...
    	<tr>
    		<th background="Admin/images/tab_14.gif">广告ID</th>
    		<th background="Admin/images/tab_14.gif">广告类型</th>
    		<th background="Admin/images/tab_14.gif">描述</th>
    		<th background="Admin/images/tab_14.gif">起始时间</th>
    		<th background="Admin/images/tab_14.gif">截止时间</th>
    		<th background="Admin/images/tab_14.gif">图片</th>
    	...
    	<c:forEach var="ad" items="${adList}">
    		<tr>
    			...
    			<td bgcolor="#FFFFFF" class="STYLE2">${ad.adtype==0?'商品推荐':'商品促销' }</td>
    			...
    			<td bgcolor="#FFFFFF" class="STYLE2"><a href="getOneADServlet?id=${ad.id}">详情</a></td>
    		</tr>
    	</c:forEach>
    	</form>
    </table>
        ...
        <td background="Admin/images/tab_21.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
           <td>
    		...
    		<input type="button" value="删除" onclick="removeAD(${adPager.pageOffset},${adPager.pageSize})">
    		</td>
