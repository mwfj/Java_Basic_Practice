  ...
  <head>
	...
	<style type="text/css">
		...
		function removeNote(pageOffset,pageSize) {
			...
			oform.action = "deleteCommentServlet?Ids="+comments+"&pageOffset="+pageOffset+"&pageSize="+pageSize;
			oform.submit();
		}
	</script>
  </head>
      				...
      				<tr>
				        ...
				        <td bgcolor="#f3ffe3">
				        	<table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#c0de98" >
    							<tr>
						    		<th background="Admin/images/tab_14.gif">评论ID</th>
						    		...
						    		<th background="Admin/images/tab_14.gif">商品ID</th>
						    	...
						    	<c:forEach var="comment" items="${commentList}">
						    		<tr>
						    			<td bgcolor="#FFFFFF" class="STYLE2">${comment.id }</td>
						    			<td bgcolor="#FFFFFF" class="STYLE2">${comment.ctitle }</td>
						    			<td bgcolor="#FFFFFF" class="STYLE2">${comment.username }</td>
						    			<td bgcolor="#FFFFFF" class="STYLE2" width="100px">${comment.cdate }</td>
						    			<td bgcolor="#FFFFFF" class="STYLE2"><span title="${comment.content}">${comment.content }</span></td>
						    			<td bgcolor="#FFFFFF" class="STYLE2" width="100px">${comment.productid }</td>
						    			<td bgcolor="#FFFFFF" class="STYLE2"><input type="checkbox" name="delete" value="${comment.id }"></td>
						    		</tr>
						    	</c:forEach>
						    	</form>
    						</table>
      		 ...
      		 <tr>
        		...
        		<td background="Admin/images/tab_21.gif">
        			<table width="100%" border="0" cellspacing="0" cellpadding="0">
          				<tr>
           					<td>
					    		<pg:pager items="${commentPager.totalNum }" maxPageItems="${commentPager.pageSize}" export="currentPageNo = pageNumber" url="getNotePagerServlet">
						         <pg:param name="pageSize" value="${commentPager.pageSize }"/>
						         ...
						         <pg:pages>
							         <c:choose>
							            <c:when test="${commentPager.pagecurrentPageNo eq pageNumber}">
  						...
  						<td colspan="1" align="right">
  							<input type="button" value="删除" onclick="removeNote(${commentPager.pageOffset},${commentPager.pageSize})">
  						</td>
