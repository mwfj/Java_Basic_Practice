  ...
  <head>
	...
	<script type="text/javascript">
		...
		function save(){
			...
			var id=$("#brandid").val();
			var param="name="+brandName+"&id="+id+"&type=brand";
...
<center>
	<table>
    	<tr>
    		<td>ID</td>
    		<td><input type="text" id="brandid" name="brandid" value="${brand.brandid}" readonly="readonly"/></td>
    	</tr>
    	<tr>
    		<td>品牌名称</td>
    		<td><input type="text" id="brandname" name="brandname" value="${brand.brandname } " readonly="readonly"/></td>
    	</tr>
    	<tr>
    		<td>
    		...
    		<td><a href="Admin/controller/brandController.jsp">返回</a></td>
    	</tr>
    </table>
</center>
		</td>
