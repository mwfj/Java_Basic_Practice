    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
    	...
    	<tr>
    		...
    		<th background="Admin/images/tab_14.gif">电话</th>
    	...
    	<c:forEach var="order" items="${ orderList}">
    		<tr>
    			...
    			<td bgcolor="#FFFFFF" class="STYLE2">${order.username }</td>
    			<td bgcolor="#FFFFFF" class="STYLE2">${order.realname }</td>
    			<td bgcolor="#FFFFFF" class="STYLE2">${order.address }</td>
    			<td bgcolor="#FFFFFF" class="STYLE2">${order.postcode}</td>
    			<td bgcolor="#FFFFFF" class="STYLE2">${order.phone}</td>
        ...
        <td background="Admin/images/tab_21.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
           <td>
    		...
    		<input type="button" value="完成" onclick="freezeOrder(${orderPager.pageOffset},${orderPager.pageSize})">
    		</td>
