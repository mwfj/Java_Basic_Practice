...
<center>
	<table>
    	...
    	<tr>
    		<td>真名</td>
    		<td><input type="text" name="trueName" value="${user.truename }" readonly="readonly"/></td>
    	</tr>
    	
    	<tr>
    		<td>性别</td>
    		<td><input type="text" name="sex" value="${user.gender }" readonly="readonly"/></td>
    	</tr>
    	
    	<tr>
    		<td>生日</td>
    		<td><input type="text" name="birthday" value="${user.birthday }" readonly="readonly"/></td>
    	</tr>
    	<tr>
    		<td>家庭住址</td>
    		<td><input type="text" name="address" value="${user.address }" readonly="readonly"/></td>
    	</tr>
    	<tr>
    		<td>邮编</td>
    		<td><input type="text" name="postcode" value="${user.postcode }" readonly="readonly"/></td>
    	</tr>
    	<tr>
    		<td>固话</td>
    	...
    	<tr>
    		<td>手机</td>
    		<td><input type="text" name="mphone" value="${user.mobile }" readonly="readonly"/></td>
    	</tr>
    	<tr>
    		<td>积分</td>
    		<td><input type="text" name="score" value="${user.score }" readonly="readonly"/></td>
    	</tr>
    </table>
