...
<center>
	<table>
    	<tr>
    		<td>ID</td>
    		<td><input type="text" id="typeid" name="typeid" value="${subType.subTypeId}" readonly="readonly"/></td>
    	</tr>
    	<tr>
    		<td>小类名称</td>
    		<td><input type="text" id="typename" name="typename" value="${subType.typeName } " readonly="readonly"/></td>
    	</tr>
    	<tr>
    		<td>
    		...
    		<td><a href="Admin/controller/subTypeController.jsp">返回</a></td>
    	</tr>
    </table>
</center>
		</td>
