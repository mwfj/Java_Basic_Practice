  ...
  <tr>
    ...
    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#c0de98">
    	<tr>
    		...
    		<th background="Admin/images/tab_14.gif" class="STYLE1">产品编号</th>
    		<th background="Admin/images/tab_14.gif" class="STYLE1">产品名</th>
    	...
    	<c:forEach var="orderItem" items="${order.orderItem}">
    		<tr>
    			...
    			<td bgcolor="#FFFFFF" class="STYLE2">${orderItem.id }</td>
    			<td bgcolor="#FFFFFF" class="STYLE2">${orderItem.productid }</td>
    			<td bgcolor="#FFFFFF" class="STYLE2">${orderItem.productname }</td>
    	...
    	<br>
    	<center><input type="button" onclick="window.history.go(-1)" value="返回" /></center>
    </td>
