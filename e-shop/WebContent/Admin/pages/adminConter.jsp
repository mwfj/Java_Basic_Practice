			...
			<div class="left-column-box">
				...
				<div id="manageUser" style="display:none;">
					<ul>
						...
						<li><a href="getMerchantPagerServlet" target="contentIframe" style="text-decoration:none; ">第三方商户</a></li>
					</ul>
				</div>
			</div>
			<div class="left-column-box">
				...
				<div id="manageOrder" style="display:none;  ">
					...
					<ul>
						...
						<li><a href="getOrderFreezePagerServlet" target="contentIframe" style="text-decoration:none; ">已完成订单</a></li>
					</ul>
				</div>
			</div>
			<div class="left-column-box">
				...
				<div id="manageProduct" style="display:none; ">
					<ul>
						<li><a href="Admin/controller/superTypeController.jsp" target="contentIframe" style="text-decoration:none; ">添加大类</a></li>
						<li><a href="Admin/controller/subTypeController.jsp" target="contentIframe" style="text-decoration:none; ">添加小类</a></li>
						<li><a href="Admin/controller/attributeController.jsp" target="contentIframe" style="text-decoration:none; ">添加属性</a></li>
						<li><a href="Admin/controller/brandController.jsp" target="contentIframe" style="text-decoration:none; ">添加品牌</a></li>
						<li><a href="Admin/pages/addProduct.jsp" target="contentIframe" style="text-decoration:none; ">添加商品</a></li>
						<li><a href="getProdPagerServlet" target="contentIframe" style="text-decoration:none; ">查看商品</a></li>
					</ul>
				</div>
			</div>
			<div class="left-column-box">
				...
				<div id="manageInform" style="display:none; ">
					<ul>
						<li><a href="Admin/pages/addNotice.jsp" target="contentIframe" style="text-decoration:none; ">添加公告</a></li>
						<li><a href="getNoticePagerServlet" target="contentIframe" style="text-decoration:none; ">查看公告</a></li>
						<li><a href="Admin/pages/addAD.jsp" target="contentIframe" style="text-decoration:none; ">添加广告</a></li>
						<li><a href="getADPagerServlet" target="contentIframe" style="text-decoration:none; ">查看广告</a></li>
					</ul>
				</div>
			</div>
			<div class="left-column-box">
				...
				<div id="manageLiuyan" style="display:none; ">
					<ul>
						<li><a href="getCommentPagerServlet" target="contentIframe" style="text-decoration:none; ">查看评论</a></li>
					</ul>
				</div>
			</div>
			<div class="left-column-box">
				...
				<div id="manageMessage" style="display:none; ">
					<ul>
						<li><a href="qq/jsp/admin.jsp" target="contentIframe" style="text-decoration:none; ">消息</a></li>
					</ul>
				</div>
			</div>
		</div>
